...
var CampaignsController = function () {
    var _classDecorators = [(0, common_1.Controller)('api/campaigns')];
    ...
    var CampaignsController = _classThis = /** @class */ (function () {
        ...
        CampaignsController_1.prototype.create = function (createCampaignDto) {
            return this.campaignsService.create(createCampaignDto);
        };
        CampaignsController_1.prototype.findAll = function () {
